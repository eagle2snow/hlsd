...
<body>
	<center>
		<br/><br/>
		<div><img alt="" src="../uploadFiles/upload/weixin/suc.jpg" width="100px;" height="100px;"/></div>
		<h3>${message}</h3>
		<h5>昵称:${snsUserInfo.nickname}</h5>
		<div>
			<img src="${snsUserInfo.headImgUrl}" width="35%;" height="35%;">
		</div>
		<h6 style="color: #808080">您可以返回APP进行提现操作了</h6>
		<button class="hotline24" onclick="allclose()">确定</button>
	</center>
</body>
