						...
						<div class="col-xs-12">
							<table style="margin-top: 8px;">
								<tr height="35">
									<c:if test="${QX.add == 1 }">
									<td style="width:69px;">
										<a href="javascript:addRole(0);" class="btn btn-sm btn-success">新增组</a>
									</td>
									</c:if>
										<c:choose>
							...
							<table id="dynamic-table" class="table table-striped table-bordered table-hover" style="margin-top:7px;">
								...
								<tr>
									...
									<th class="center" style="width:80px;text-align: center;">排序号</th>
									</c:if>
									<th style="width:200px;text-align: center;" class="center">操作</th>
								</tr>
								</thead>
								<c:choose>
	...
	<script type="text/javascript">
		...
		function addRole(pid){
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/role/toAdd.do?parent_id='+pid,
				  cancel:function(){
		...
		function editRole(ROLE_ID){
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/role/toEdit.do?ROLE_ID='+ROLE_ID,
				  cancel:function(){
					  setTimeout("self.location.reload()",100);
				  }
			 });
		...
		function editRights(ROLE_ID){
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/role/menuqx.do?ROLE_ID='+ROLE_ID,
				  cancel:function(){
					  setTimeout("self.location.reload()",100);
				  }
			 });
		...
		function roleButton(ROLE_ID,msg){
			if(msg == 'add_qx'){
			 ...
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/role/b4Button.do?ROLE_ID='+ROLE_ID+'&msg='+msg,
				  cancel:function(){
					  setTimeout("self.location.reload()",100);
				  }
			 });
