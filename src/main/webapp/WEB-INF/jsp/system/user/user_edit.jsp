						...
						<div class="col-xs-12">
								<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">
											...
											<td>
												<div class="form-group draggable">
														...
														<div class="selQ591649188Qsel"></div>
															<select class="chosen-select form-control" name="name" id="id" data-placeholder="请选择省">
																<option id="s_province"  value="province"></option>
																<option id="s_province"  value="province">广东省</option>
																<option id="s_city"  value="s_city">广西省</option>
																<option id="s_county"  value="s_county">北京省</option>
														  	</select>
													  		<div class="selQ591649188Qsel"></div>
														</div>
											      </div>
