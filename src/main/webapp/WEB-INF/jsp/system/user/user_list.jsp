				...
				<div class="page-content">
					<div class="row">
						...
						<table style="margin-top:5px;width: 100%;">
							...
							<td style="width: 38%;">
								<c:if test="${QX.cha == 1 }">
								<a class="btn btn-light btn-xs" onclick="searchs();"  title="检索"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i>查询</a>
								<c:if test="${QX.add == 1 }"><a class="btn btn-light btn-xs" onclick="add();"><i id="nav-search-icon" class="ace-icon fa fa-plus bigger-110 nav-search-icon blue"></i>新增</a></c:if>
								<c:if test="${QX.toExcel == 1 }"><a class="btn btn-light btn-xs" onclick="toExcel();" title="导出到EXCEL"><i id="nav-search-icon" class="ace-icon fa fa-download bigger-110 nav-search-icon blue"></i>导出</a></c:if>
								<c:if test="${QX.FromExcel == 1 }"><a class="btn btn-light btn-xs" onclick="fromExcel();" title="从EXCEL导入"><i id="nav-search-icon" class="ace-icon fa fa-cloud-upload bigger-110 nav-search-icon blue"></i>导入</a></c:if>
								</c:if>
