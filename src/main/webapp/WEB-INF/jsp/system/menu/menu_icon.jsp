				...
				<div class="page-content">
					...
					<div class="row">
						...
						<table id="dynamic-table" class="table table-striped table-bordered">
							...
							<tr>
								<td><label onclick="seticon('menu-icon fa fa-battery-half ');"><i class="menu-icon fa fa-battery-half "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td><label onclick="seticon('menu-icon fa fa-wikipedia-w ');"><i class="menu-icon fa fa-wikipedia-w "></i>&nbsp;<input name="form-field-radio" type="radio" value="icon-edit"><span class="lbl"></span></label></td>
								<td colspan="10">
									<i class="menu-icon fa fa-user-circle" aria-hidden="true"></i>
									<i class="menu-icon fa fa-thumbs-o-up" aria-hidden="true"></i>
								</td>
							</tr>
							<tr>
								<td colspan="19">
								<label>其他几百个可以参考这里 保存到数据库  <a href="http://fontawesome.io/icons/" target="_blank">http://fontawesome.io/icons/</a></label>
								</td>
							</tr>
