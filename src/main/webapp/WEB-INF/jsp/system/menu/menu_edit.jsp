					...
					<div class="page-header">
							<h1>
								...
								<small style="float: right;">
									<c:if test="${QX.add == 1 }"><a class="btn btn-sm btn-success" onclick="addmenu('${pd.MENU_ID}');">新增</a></c:if>
								</small>
							</h1>
					</div><!-- /.page-header -->
					...
					<div class="row">
						...
						<form  action="menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="parentMenuName" value="${null == pds.MENU_NAME ? '此项为顶级菜单':pds.MENU_NAME}" onclick="selectMenuTree();"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									...
									<a class="btn btn-mini btn-danger" onclick="javascript:top.layer.closeAll();">取消</a>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		function selectMenuTree(){
			layer.open({
			  ...
			  shade: 0.1,
			  maxmin: false,
			  content: '<%=basePath%>menu/selectMenuTree.do'
			});
		}
