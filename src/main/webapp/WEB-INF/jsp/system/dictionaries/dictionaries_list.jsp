							...
							<tr>
							 <td style="width: 80%;">
								...
								<td style="vertical-align:top;width: 15%;">
									<c:if test="${QX.cha == 1 }">
									<a class="btn btn-xs btn-success" onclick="tosearch();">查询</a>
									</c:if>
									<c:if test="${QX.add == 1 }">
	...
	<script type="text/javascript">
		...
		function add(DICTIONARIES_ID){
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/dictionaries/goAdd.do?DICTIONARIES_ID='+DICTIONARIES_ID,
				  cancel:function(){
		...
		function edit(Id){
			 top.layer.open({
				  ...
				  shade: 0.1,
				  maxmin: false,
				  content: '${ctx}/dictionaries/goEdit.do?DICTIONARIES_ID='+Id,
				  cancel:function(){
					  parent.location.href="${ctx}/dictionaries/listAllDict.do?DICTIONARIES_ID=${DICTIONARIES_ID}&dnowPage=${page.currentPage}";
				  }
			});
