...
$(function(){
	if('main'== locat[3]){
		locat =  locat[0]+'//'+locat[2];}else{locat =  locat[0]+'//'+locat[2]+'/'+locat[3];
	};
 });
...
function editPhoto(){
	 top.layer.open({
	  ...
	  shade: 0.1,
	  maxmin: false,
	  content: locat+'/head/editPhoto.do'
	});
}
...
function editUserH(){
  top.layer.open({
	  ...
	  shade: 0.1,
	  maxmin: false,
	  content: locat+'/user/goEditMyU.do'
	});
}
...
function editSys(){
 top.layer.open({
	  ...
	  shade: 0.1,
	  maxmin: false,
	  content: locat+'/head/goSystem.do'
	});
}
...
function fhsms(){
 top.layer.open({
	  ...
	  shade: 0.1,
	  maxmin: false,
	  content: locat+'/fhsms/list.do?STATUS=2'
	});
}
