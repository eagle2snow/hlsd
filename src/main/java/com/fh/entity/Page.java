...
public class Page<T> {
	...
	private List<Map<String,Object>> doaminList;
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("	<li><select title='显示条数' style=\"width:62px;float:left;margin-top:1px;\" onchange=\"changeCount(this.value)\">\n");
	...
	public List<Map<String, Object>> getDoaminList() {
		return doaminList;
	}

	public void setDoaminList(List<Map<String, Object>> doaminList) {
		this.doaminList = doaminList;
	}
