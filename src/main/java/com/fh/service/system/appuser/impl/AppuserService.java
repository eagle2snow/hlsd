...
public class AppuserService implements AppuserManager{
	...
	@Override
	public PageData findByUsernameAndRoleId(PageData pd) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.findByUsernameAndRoleId", pd);
	}

	@Override
	public PageData findByUsernameAndPwd(PageData pd) throws Exception {
		return (PageData)dao.findForObject("AppuserMapper.findByUsernamePwd", pd);
	}
