package com.fh.controller.test.dept;
...
public class DeptController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd = this.getPageData();
		pd.put("DEPT_ID", this.get32UUID());	//主键
		deptService.save(pd);
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("test/dept/dept_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("test/dept/dept_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("DEPTID"));	    //1
			...
			vpd.put("var5", varOList.get(i).getString("UPDATEUSER"));	    //5
