...
public class HttpUtil {
	...
	public static String getRequestString(int requestType,String url,Map<String, String> param,
		...
		if (outPutString != null) {
			...
			StringEntity entity = new StringEntity(outPutString,"UTF-8");//解决中文乱码问题    
            entity.setContentEncoding("UTF-8");    
            post.setEntity(entity);
		}
		return getRequestString(buildRequest,HttpClients.createDefault());
	}
	 ...
	 * @return
	 */
    public static String sendPostHttps(String url,Map<String,String> map){  
