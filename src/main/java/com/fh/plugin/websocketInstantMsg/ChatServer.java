...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("Administrator")){
			this.userjoin(message.replaceFirst("Administrator", ""),conn);
		}if(null != message && message.startsWith("LeaveAdministrator")){
			this.userLeave(conn);
